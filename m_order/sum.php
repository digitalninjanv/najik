...
// 1. Ambil Data Order (Digunakan di ketiga halaman)
...
// 3. Ambil data kas untuk Invoice 2
...
// 4. Hitung total Invoice 1 (TOTAL INVOICE di halaman pertama)
    ...
    <table>
      ...
      <tr>
        ...
        <td style="text-align:right; width:140px; font-variant-numeric:tabular-nums;">
            <?php
            echo "Rp " . number_format($handlingFee, 0, ',', '.');
            ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td style="text-align:right; width:140px; font-variant-numeric:tabular-nums; font-weight:bold; border-top:1px solid #000; padding-top:8px;">
            <?php
            echo "Rp " . number_format($totalInvoiceOne, 0, ',', '.');
            ?>
      </td>
    </tr>
  </table>
...
<div class="summary-page">
  ...
  <table class="summary-table">
    <tr>
      <td class="label">Invoice 1 Total</td>
      <td class="value"><?php echo "Rp " . number_format($totalInvoiceOne, 0, ',', '.'); ?></td>
    </tr>
    <tr>
      <td class="label">Invoice 2 Total</td>
      <td class="value"><?php echo "Rp " . number_format($grandTotalRincian, 0, ',', '.'); ?></td>
    </tr>
    <tr>
      <td class="label">Grand Total</td>
      <td class="value"><?php echo "Rp " . number_format($totalInvoiceOne + $grandTotalRincian, 0, ',', '.'); ?></td>
    </tr>
  </table>
</div>
</body>
