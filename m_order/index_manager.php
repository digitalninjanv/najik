<?php
//include '../../config.php'; dimatikan karena config di taruh di awal sebelum menu ini di index.php
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php
					$totalnilais = 0;   // inisialisasi
					$totalbayars = 0;   // inisialisasi
					$count = 1;
                ...
                <tr>
                  ...
                  <b><small 
                  style="cursor: pointer;">Status : <?= $status ?></small></b>
                  ...
                  <td>
                      ...
                      <!--<a href="suratjalan.php">Surat Jalan</a> | <a href="tandaterima.php">Tanda Terima</a> -->
                      </small>
                      
                      <a href="list.php?codx=<?php echo $data['codx'];?>">
                          List️
                      </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form action="../../controller/order_controller.php?op=tambah" method="post"  enctype="multipart/form-data">
                ...
                <!-- END Tanggal Muncul Kalender -->


              <!--Ini adalah tanggal normal-->
    <!--      <div class="form-group">-->
    <!--        <label class="control-label" >Tanggal : </label>         -->
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="customer" id="customer_edit" value="" placeholder="Silahkan isi Customer" />
                    </div>
